(function(alert, text, quadrant, position, style, size){
	...
	*/
	...
	var extraStyle = "#jn-alert-3389-C277-D9IR span:first-child { display: inline; text-align: right; width: auto; } #jn-alert-3389-C277-D9IR span:last-child { display: none; } #jn-alert-3389-C277-D9IR:hover { background: rgba(0, 0, 0, 0.52312); opacity: 1; " + sizeText[1] + " } #jn-alert-3389-C277-D9IR:hover span:first-child { display: none; } #jn-alert-3389-C277-D9IR:hover span:last-child { display: block; }";
