(function(alert, text, quadrant, position, style){
	...
	var preStyle = "#" + divId + " { position: " + position + "; " + corner + " z-index: 9999; box-sizing: border-box; max-width: 378px; font-size: 15px; font-weight: 300; } #" + divId + " span * { color: inherit; text-decoration: inherit; }";
