...
blog.main = function () {
	...
	var sectionTemplate = '<section class="post" id="post__INDEX__"><h2 id="post__INDEX__h2" class="post-h2"><a id="post__INDEX__title" class="post-h2-in" href="./?p=__INDEX__">__TITLE__</a></h2><footer class="post-date"><a id="post__INDEX__link" href="./?p=__INDEX__">__DATE__</a></footer><div class="post-text" id="post__INDEX__text"></div></section>';
	var listItemTemplate = '<li><a href="./?p=__INDEX__" id="post__INDEX__h2" class="post-h2">__TITLE__</a><footer class="post-date"><a id="post__INDEX__footer" href="./?p=__INDEX__">__DATE__</a></footer></li>';
